    ...
    <div class="w-full max-w-md space-y-8">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
          Or
          {{ ' ' }}
          <router-link :to="{ name: 'Login' }" class="font-medium text-indigo-600 hover:text-indigo-500">Sign in to
      ...
      <form class="mt-8 space-y-6" @submit="register">
        ...
        <div class="-space-y-px rounded-md shadow-sm">
          <div>
            ...
            <input id="full_name" name="name" type="text" autocomplete="name" required="" v-model="user.name"
